#######################################################
# Tool to monitor IXON adapter connection state. It shows a banner on top of your screens with the IXON adapter status.
# 
#### How to install ####
...
#### How to use ####
# Shows a little 'Not active' (White) indicator on top of your screen if no IXON connection is active.
...
class Banner:
    ...
    def UpdateBanner(self):
        ...
        if is_vpn_active("IXON"):
            ...
            self.label.config(text=f'VPN ACTIVE - {connected_client}')
